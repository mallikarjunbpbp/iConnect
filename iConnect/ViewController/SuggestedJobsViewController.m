...
#import "SuggestedJobsViewController.h"
#import <Parse/Parse.h>
#import "JobDetailViewController.h"
#import "UserSingleton.h"

@interface SuggestedJobsViewController ()
@property(nonatomic,strong) NSMutableArray *array;
@end

@implementation SuggestedJobsViewController
...
- (void)viewDidLoad {
    ...
    [query whereKey:@"issuggested" equalTo:[NSNumber numberWithBool:YES]];
    [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        if(!error)
        {
            ...
            [self.suggestedJobsTableView reloadData];
        }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SuggestedJobsCell"];
